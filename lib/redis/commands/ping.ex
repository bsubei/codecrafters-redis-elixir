defmodule Redis.Commands.Ping do
  ...
  defp handle_request(connection, ["PING"]) do
    ...
    connection = put_in(connection.handshake_status, new_handshake_status)
    Connection.send_message(connection, RESP.encode("PONG", :simple_string))
  end
  ...
  defp handle_request(connection, ["PING", arg]) do
    Connection.send_message(connection, RESP.encode(arg, :bulk_string))
  end
end
